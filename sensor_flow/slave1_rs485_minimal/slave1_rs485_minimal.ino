...
void setup() {
  ...
  Serial.println("========================================");
  Serial.println("HANYA test RS485, tanpa sensor lain");
  Serial.println("DE/RE: D2, RO: D10, DI: D11");
  Serial.println("========================================");
...
void sendResponse(String response) {
  ...
  delayMicroseconds(200);  // Longer delay untuk stability

  SlaveBus.print(response);
  SlaveBus.print('\n');
  SlaveBus.flush();

  delay(10);  // Wait untuk transmission complete
